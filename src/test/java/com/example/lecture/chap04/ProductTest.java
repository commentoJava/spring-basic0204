...
import com.example.lecture.chap04.domain.QProduct;
import com.example.lecture.chap04.domain.QStore;
import com.example.lecture.chap04.domain.Store;
import com.example.lecture.chap04.dto.ProductDto;
import com.example.lecture.chap04.dto.QProductDto;
...
class ProductTest {
    ...
    void querydslTesting18(){
        ...
        for (Tuple tuple : result) {
            log.info("\n name ={} price = {} rankPath = {}", tuple.get(QProduct.product.productName),tuple.get(QProduct.product.price), tuple.get(rankPath));
        }
    }
